...
public class NetFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(NetFramework.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateNetFramework_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateNetFramework_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				NetFramework.ByteBuffer obj = new NetFramework.ByteBuffer();
			...
			else if (count == 1)
			{
				...
				NetFramework.ByteBuffer obj = new NetFramework.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: NetFramework.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			NetFramework.ByteBuffer obj = (NetFramework.ByteBuffer)ToLua.CheckObject<NetFramework.ByteBuffer>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
